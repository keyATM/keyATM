...
// topicdict_train_totcov
List topicdict_train_totcov(List model, int iter, int output_per);
RcppExport SEXP _topicdict_topicdict_train_totcov(SEXP modelSEXP, SEXP iterSEXP, SEXP output_perSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List >::type model(modelSEXP);
    Rcpp::traits::input_parameter< int >::type iter(iterSEXP);
    Rcpp::traits::input_parameter< int >::type output_per(output_perSEXP);
    rcpp_result_gen = Rcpp::wrap(topicdict_train_totcov(model, iter, output_per));
    return rcpp_result_gen;
END_RCPP
}
// lda_cov
...
RcppExport SEXP _topicdict_LDA_weight_tot(SEXP modelSEXP, SEXP iterSEXP, SEXP output_perSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List >::type model(modelSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_topicdict_topicdict_train_totcov", (DL_FUNC) &_topicdict_topicdict_train_totcov, 3},
    ...
    {"_topicdict_LDA_weight_tot", (DL_FUNC) &_topicdict_LDA_weight_tot, 3},
    {NULL, NULL, 0}
};
