...
List keyATM_fit_multi_base(List model, int iter);
RcppExport SEXP _keyATM_keyATM_fit_multi_base(SEXP modelSEXP, SEXP iterSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< List >::type model(modelSEXP);
    Rcpp::traits::input_parameter< int >::type iter(iterSEXP);
    rcpp_result_gen = Rcpp::wrap(keyATM_fit_multi_base(model, iter));
    return rcpp_result_gen;
END_RCPP
}
// keyATM_fit_cov
