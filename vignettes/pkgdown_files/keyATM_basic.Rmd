...
## Preparing documents
Please read [Preparation](Preparation.html) for the three data types that **keyATM** can read. **keyATM** package includes a tidy dataset for illustration purpose.
