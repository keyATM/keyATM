...
### Keywords list
Keywords should be in a list. For example, we prepare four keyword-topics. Keywrods should be stored in a list. Each element in the list is a character vector, which corresponds to a single keyword-topic. The number of keywords can vary between topics. Please also check [FAQ](FAQ.html#how-to-select-keywords) to see how to select keywords that help models.
