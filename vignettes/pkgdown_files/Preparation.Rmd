...
**keyATM** can read a `dfm` object created by **quanteda** package (**this method is strongly recommended**). Since **keyATM** does not provide preprocessing functions, we recommend users to preprocess documents with **quanteda**. Please visit [quanteda Quick Start: Creating a Corpus](https://quanteda.io/articles/quickstart.html#creating-a-corpus) to see how to create a `corpus` object.
