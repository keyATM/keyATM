...
**keyATM** also provides [the Pólya-Gamma augmentation](keyATM_cov.html#keyatm-covariate-with-pólya-gamma-augmentation) as an alternative modeling approach for topic assignments.
