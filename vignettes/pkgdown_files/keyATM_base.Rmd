...
for other options). The default number of iterations is 3000.
...
```
The default number of iterations is `3000`. Please check [this page](Options.html) for available options.
