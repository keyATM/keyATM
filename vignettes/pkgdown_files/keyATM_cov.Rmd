...
Section 3 of [Eshima et al. (2020)](https://arxiv.org/abs/2004.05964) explain the covariate keyATM in details.
...
fig_doctopic <- plot(strata_topic, var_name = "Period",
...
```{r, warning=FALSE, message=FALSE, fig.align='center'}
strata_rep <- by_strata_DocTopic(out, by_var = "PartyRepublican",
                                 labels = c("Non-Republican", "Republican"))
strata_dem <- by_strata_DocTopic(out, by_var = "PartyDemocratic",
...
out <- keyATM(docs              = keyATM_docs,
              ...
              options           = list(seed = 250),
              keep              = c("Z", "S"))
strata_tw <- by_strata_TopicWord(out, keyATM_docs,
...
Please read Appendix S3 of Eshima, Imai, and Sasaki (2020) for details.
