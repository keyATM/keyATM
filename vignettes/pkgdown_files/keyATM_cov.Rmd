...
argument. Researchers can glance covariate information with the 
...
the 95% credible intervals of them for each value of covariates. 
...
Using the output of the `keyATM`, we can calculate 95% credible intervals 
