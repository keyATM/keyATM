...
With **keyATM** covariates, we can calculate the predicted posterior distribution of the document-topic distributions. This is for [keyATM Covariate](keyATM_cov.html).
...
plot(strata_topic, topics = c(1,2,3,4))
```
