...
HMM model needs a vector of time indexes. This is an "index" and not the actural time stamps (year and date). For examplle, `bills` data contain session information, which ranges from `101` to `114`. 
