...
explore_$show_words_documents("w65t5")
explore_$show_words(c('w11t1','w64t1', 'w273t1'))
```

# Use Simulation Data 1 (more topic)
Use high to middle proportion words:
```{r, warning=FALSE, message=FALSE, fig.width=6, fig.height=4}
explore_$show_words(c('w0t1','w67t1', 'w223t2', "w536t2", "w1656t3",
...
explore_$show_words(c("w1394t1", "w27t1", "w291t1",
...
explore_ <- explore(docs,
             ...
             remove_separators = TRUE)
explore_$top_words(10)
explore_$show_words(c("w1077t1", "w1077t1", "w971t1", 
...
explore_ <- explore(docs,
             ...
             remove_separators = TRUE)
explore_$top_words(10)
explore_$show_words(c("w1077t1", "w1077t1", "w971t1", "w3448t1", "w2757t1",
...
explore_ <- explore(docs,
             ...
             remove_separators = TRUE)
explore_$top_words(10)
explore_$show_words(c("w1077t1", "w1077t1", "w971t1", "w249t1",
