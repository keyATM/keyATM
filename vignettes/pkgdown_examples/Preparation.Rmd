...
Keywords should be in a list. For example, let's prepare two keyword-topics. The number of keywords can vary between topics. Please also check [Guidelines](Guidlines.html) to see how to select keywords that help models.
...
You can find details in [Guidelines](Guidlines.html#which-model-to-use).
