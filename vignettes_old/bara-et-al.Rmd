...
model <- topicdict_model(dir(doc_folder, full.names = T), dict, stopwords = stops)
```
...
But let's look at these in terms of lift (higher probability relative to a corpus frequency baseline)
```{r}
