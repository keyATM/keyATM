...
Gen_w_seeds <- function(index, phiR, phiS, z, x, seed_words){
	...
	if (indicator == 0){
		...
		word <- paste0("W", as.character(word)) # no overlap of words between topics
	} else {
		# Seed words
...
create_sim_data <- function(saveDir, D=200, K=10, TotalV=1500, alpha=0.1, beta_r=0.1, beta_s=0.1, p=NULL, gamma1=NULL, gamma2=NULL, lambda=300, seeds_len=5, prop_seeds=NULL, rand_seed=123){
